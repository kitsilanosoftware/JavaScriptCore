...
//+EAWebKitChange
//5/9/2012 Disabled the checks. They unduly tax our debug builds and depending upon the page,
// it may be very slow to use. Couldn't do it just for PLATFORM(EA) since that header is not included here.
#else
#define CHECK_HASHTABLE_ITERATORS 0
#define CHECK_HASHTABLE_USE_AFTER_DESTRUCTION 0
#endif
