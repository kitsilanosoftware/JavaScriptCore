...
extern "C" void JITStubThunked_optimize_from_loop(STUB_ARGS_DECLARATION);
__asm void cti_optimize_from_loop(STUB_ARGS_DECLARATION)
{
    PRESERVE8
    IMPORT JITStubThunked_optimize_from_loop
    str lr, [sp, # THUNK_RETURN_ADDRESS_OFFSET]
    bl JITStubThunked_optimize_from_loop
    ldr lr, [sp, # THUNK_RETURN_ADDRESS_OFFSET]
    bx lr
}

extern "C" void JITStubThunked_optimize_from_ret(STUB_ARGS_DECLARATION);
__asm void cti_optimize_from_ret(STUB_ARGS_DECLARATION)
{
    PRESERVE8
    IMPORT JITStubThunked_optimize_from_ret
    str lr, [sp, # THUNK_RETURN_ADDRESS_OFFSET]
    bl JITStubThunked_optimize_from_ret
    ldr lr, [sp, # THUNK_RETURN_ADDRESS_OFFSET]
    bx lr
}
