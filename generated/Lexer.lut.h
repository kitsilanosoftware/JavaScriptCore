// Automatically generated from ..\..\..\Source\JavaScriptCore\parser\Keywords.table using C:/dsiems/Latest/Webkit9-15-Pristine/Source/JavaScriptCore/create_hash_table. DO NOT EDIT!
...
static const struct HashTableValue mainTableValues[46] = {
   ...
   { "implements", 0, (intptr_t)(RESERVED_IF_STRICT), (intptr_t)0 THUNK_GENERATOR(0) },
   { "interface", 0, (intptr_t)(RESERVED_IF_STRICT), (intptr_t)0 THUNK_GENERATOR(0) },
   { "let", 0, (intptr_t)(RESERVED_IF_STRICT), (intptr_t)0 THUNK_GENERATOR(0) },
   { "package", 0, (intptr_t)(RESERVED_IF_STRICT), (intptr_t)0 THUNK_GENERATOR(0) },
   { "private", 0, (intptr_t)(RESERVED_IF_STRICT), (intptr_t)0 THUNK_GENERATOR(0) },
   { "protected", 0, (intptr_t)(RESERVED_IF_STRICT), (intptr_t)0 THUNK_GENERATOR(0) },
   { "public", 0, (intptr_t)(RESERVED_IF_STRICT), (intptr_t)0 THUNK_GENERATOR(0) },
   { "static", 0, (intptr_t)(RESERVED_IF_STRICT), (intptr_t)0 THUNK_GENERATOR(0) },
   { "yield", 0, (intptr_t)(RESERVED_IF_STRICT), (intptr_t)0 THUNK_GENERATOR(0) },
